...
hello
        ...
        <div className='bg-dark-purple  md:w-1/3 hidden md:block  relative'>hell2
...
<img src={vector3}></img>
<div className='mt-5 w-1/2'>Contact the Organisers</div>
  </div>
  <div  className='mt-10 flex-col'>person1
  <div className='mt-5 w-1/2'>
    +91XXXXXXXXXX</div></div>
  <div  className='mt-10 flex-col'>person2
  <div className='mt-5 w-1/2'>
    +91XXXXXXXXXX</div></div>
  <div  className='mt-10 flex-col'>person3
  <div className='mt-5 w-1/2'>
    +91XXXXXXXXXX</div></div>
    </div>
