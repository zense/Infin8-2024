...
const Slider = () => {
  ...
  return (
    <div className='slider-screen w-screen h-screen overflow-auto relative' id='gallery' onScroll={handleScroll}  onMouseDown={mouseDownHandler} onMouseMove={mouseMoveHandler} onMouseUp={handleMouseUp}>
